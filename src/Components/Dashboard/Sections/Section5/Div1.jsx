...
import LineChart3 from '../Section4/LineChart3';
import BarChart3 from '../Section4/BarChart3';
...
const Div1 = () => {
    ...
    return (
        <>
            <Grid className='ms-2 mx-2 mt-1' container sx={{ border: "1px solid #8A919E", borderRadius: "4px 4px 4px 4px" }}>
                <Grid className='mt-3 mb-2' item xs={12} sm={12} md={12} lg={12} >
                    <h6 className="sec5h6 mt-2 ms-3">Responses</h6>
                </Grid>
            </Grid>
            <Grid className='ms-2 mx-2' container sx={{ border: "1px solid #8A919E", borderRadius: "4px 4px 4px 4px" }}>
                <Grid className='mt-3 mb-2' item xs={12} sm={12} md={12} lg={9.8} >
                    <h6 className="sec5h6 mt-2 ms-2">Total Messages:
                        <span style={{ fontSize: "12px", color: "#938CFF" }}> 6203</span></h6>
                </Grid>
